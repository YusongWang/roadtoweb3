...
contract Staker {
    ...
    uint256 public constant rewardPerBlock = 2 ether;
  ...
  */
        ...
        notCompleted
    {
        ...
        uint256 myRate = individualBalance / totalBalances;
        ...
        uint256 indBalanceRewards = individualBalance +
            ((block.number - depositBlocks[msg.sender]) *
                (rewardPerBlock * myRate));
  ...
  */
    ...
    function giveBack() public {
      exampleExternalContract.sendToOwner();
    }
}
